    ...
    <div class="col-12">
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel">Tambah Afdeling</h4>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" readonly parsley-trigger="change"
                                        placeholder="Masukkan Nama Kebun" value="{{ $kebun->nama }}"
                                        class="form-control">
                                </div>
                                <div class="form-group col-md-12">
                                    <label>Nama</label>
        ...
        <div id="editData" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel">Edit Afdeling</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    </div>
                    <div class="modal-body">
...
<script type="text/javascript">
    ...
    $(function() {
        window.table = $('#datatable').DataTable({
            ...
            pageLength: 25,
            ajax: {
                url: "{{ route('admin.afdeling.data',$kebun->id)}}",
            },
            columns: [
                {   
                    data: 'DT_RowIndex', 
        ...
        $('#formAdd').on('submit', function(e){
            ...
            $.ajax({
                url: "{{ route('admin.afdeling.store',$kebun->id) }}",
                type: "POST",
        ...
        $('body').on('submit', '#formEdit', function(){
            ...
            $.ajax({
                url: "{{ route('admin.afdeling.update',$kebun->id) }}",
                type: "POST",
                data: d,
                dataType: 'JSON'
            })
    ...
    function deleteData(id){
        Swal.fire({
            ...
            if(result.value){
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('admin.afdeling.delete',$kebun->id) }}",
                    data: {
                        "id": id,
                        "_token": "{{ csrf_token() }}",
                    },
    ...
    function editData(id){
        $.ajax({
            url : "{{ route('admin.afdeling.index',$kebun->id) }}/detail/"+id,
            type : "GET",
            datatype : "JSON",
