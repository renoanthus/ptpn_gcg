...
<div class="row">
    <div class="col-12" style="text-align: center">
        <div class="card-box">
            ...
            @php
            if ($kebun->peta != null) {
            if (!file_exists($kebun->peta)) {
            $kebun->peta = 'assets/images/peta/placeholder.jpeg';
            }
            }else{
            $kebun->peta = 'assets/images/peta/placeholder.jpeg';
            }
            @endphp
            <img src="{{ asset($kebun->peta) }}" alt="" style="max-width: 900px;">
        </div>
    </div>
    <div class="col-12">
        <h4 style="font-family: Roboto">
            {{ $kebun->wilayah->nama .' - Kebun '.$kebun->nama}}
        </h4>
        <div class="card-box">
            <table class="table table-striped" style="max-width: 50%">
                <thead>
                    <tr>
                        <th>Luas LM</th>
                        <th>:</th>
                        <th>{{ number_format($kebun->luas_lm,2,',','.') }} Ha</th>
                    </tr>
                    <tr>
                        <th>Luas Drone</th>
                        <th>:</th>
                        <th>{{ number_format($kebun->luas,2,',','.') }} Ha</th>
                    </tr>
                    <tr>
                        <th>Jumlah Pohon LM</th>
                        <th>:</th>
                        <th>{{ number_format($kebun->tegakan_lm,0,',','.') }} Pohon</th>
                    </tr>
                    <tr>
                        <th>Jumlah Pohon Drone</th>
                        <th>:</th>
                        <th>{{ number_format($kebun->tegakan,0,',','.') }} Pohon</th>
                    </tr>
                    <tr>
                        <th>Produksi Hari Ini</th>
                        <th>:</th>
                        <th>{{ $kebun->attp_atp??'-' }}</th>
                    </tr>
                    <tr>
