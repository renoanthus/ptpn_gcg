        ...
        <div class="card-box">
            <div class="row head_table">
                ...
                <div class="col-md-2 ml-auto mb-2">
                    <button class="btn btn-block btn-primary mt-0"><i class="mdi mdi-plus"></i> Tambah Data</button>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    function deleteData(id){
        Swal.fire({
            ...
            if(result.value){
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('admin.aspek.index1') }}/delete/"+id,
                    data: {
                        "id": id,
                        "_token": "{{ csrf_token() }}",
                    },
    ...
    function editData(id){
        $.ajax({
            url : "{{ route('admin.aspek.index1') }}/detail/"+id,
            type : "GET",
            datatype : "JSON",
