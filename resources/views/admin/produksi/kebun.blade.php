    ...
    <div class="col-12">
                        ...
                        <form id="formAdd" enctype="multipart/form-data" data-parsley-validate="" novalidate="">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label>Kebun :</label>
                                    <select id="f_kebun_id" class="form-control select2">
        ...
        <div class="card-box">
            <div class="row head_table">
                <div class="col-md-6">
                    <h4 class="mt-0 header-title">Produksi Wilayah {{ $wilayah->nama }}</h4>
                </div>
...
<script type="text/javascript">
    ...
    $(function() {
        window.table = $('#datatable').DataTable({
            ...
            pageLength: 25,
            ajax: {
                url: "{{ route('admin.produksi.wilayah_data',$wilayah->id)}}",
            },
            columns: [
                {   
                    data: 'DT_RowIndex', 
