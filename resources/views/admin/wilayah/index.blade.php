                        ...
                        <form id="formAdd" enctype="multipart/form-data" data-parsley-validate="" novalidate="">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" parsley-trigger="change" placeholder="Masukkan Kode Wilayah"
                                        name="kode" id="kode" class="form-control">
                                </div>
                                <div class="form-group col-md-6">
                                    <label>Nama</label>
                        ...
                        <form id="formEdit" method="post" data-parsley-validate="" enctype="multipart/form-data"
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label>Kode Wilayah</label>
                                    <input type="text" parsley-trigger="change" placeholder="Masukkan Kode Wilayah"
                                        name="kode" id="edit_kode" class="form-control">
                                </div>
                                <div class="form-group col-md-6">
                                    <label>Nama</label>
                                    <input type="text" parsley-trigger="change" placeholder="Masukkan Nama" name="nama"
...
<script type="text/javascript">
    ...
    $('body').on('submit', '#formEdit', function(){
        ...
        $.ajax({
            url: "{{ route('admin.wilayah.update') }}",
            type: "POST",
            data: d,
            dataType: 'JSON'
        })
    ...
    function deleteData(id){
        Swal.fire({
            ...
            if(result.value){
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ route('admin.wilayah.delete') }}",
                    data: {
                        "id": id,
                        "_token": "{{ csrf_token() }}",
                    },
    ...
    function editData(id){
        $.ajax({
            url : "{{ route('admin.wilayah.index') }}/detail/"+id,
            type : "GET",
            datatype : "JSON",
