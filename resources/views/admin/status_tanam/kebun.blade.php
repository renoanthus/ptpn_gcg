...
@endsection
@section('title')
Status Tanam - {{ App\Models\Bantuan::statusTanamTampil($status_tanam) }}
@endsection
@section('content')
<div class="row">
    <div class="col-12">
        ...
        <div class="card-box">
            <div class="row head_table">
                <div class="col-md-6">
                    <h4 class="mt-0 header-title">Aset Kebun Kelapa Sawit Berdasarkan Status Tanam -
...
<script type="text/javascript">
    ...
    $(function() {
        window.table = $('#datatable').DataTable({
            ...
            pageLength: 25,
            ajax: {
                url: "{{ route('admin.status_tanam.kebun.data', $status_tanam)}}",
            },
            columns: [
                {   
                    data: 'DT_RowIndex', 
