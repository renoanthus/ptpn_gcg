...
@endsection
@section('title')
Status Tanam - {{ App\Models\Bantuan::statusTanamTampil($status_tanam) }} - Kebun {{ $afdeling->kebun->nama }} -
    ...
    <div class="col-12">
        ...
        <div class="card-box">
            <div class="row head_table">
                <div class="col-md-12">
                    <h4 class="mt-0 header-title">Aset Kelapa Sawit Berdasarkan Status Tanam -
                        {{ App\Models\Bantuan::statusTanamTampil($status_tanam) }} -
...
<script type="text/javascript">
    ...
    $(function() {
        window.table = $('#datatable').DataTable({
            ...
            pageLength: 25,
            ajax: {
                url: "{{ route('admin.status_tanam.blok.data', [$status_tanam,$afdeling->id])}}",
            },
            columns: [
                {   
                    data: 'DT_RowIndex', 
